...
class LoginViewController: UIViewController {
    ...
    private let privacyButton: UIButton = {
        let button =  UIButton()
        button.setTitle("Privacy Notice", for: .normal)
        button.setTitleColor(.secondaryLabel, for: .normal)
    ...
    override func viewDidLayoutSubviews() {
        ...
        headerView.frame = CGRect(x: 0, y: 0.0,
                                  width: view.width, // Check extensions file in Resources
                                  height: view.height / 3.0)
        
        usernameEmailField.frame = CGRect(x: 25, y: headerView.bottom + 40,
                                  width: view.width - 50, // Check extensions file in Resources
                                  height: 52.0)
    ...
    private func configureHeaderView(){
        ...
        imageView.frame = CGRect(x: headerView.width / 4, y: headerView.height / 3.0, width: headerView.width / 2, height: headerView.height - view.safeAreaInsets.top)
    ...
    @objc private func didTapLoginButton() {
        ...
        guard let usernameEmail = usernameEmailField.text, !usernameEmail.isEmpty,
              let password = passwordField.text, !passwordField.isEmpty, password.count >= 8 else {
            return
        }
